...
$string['reviewlowconfidence'] = 'This review was inconclusive — the AI\'s independent samples disagreed too much to be reliable, so it is not being shown. Rely on your own grade.';
$string['reviewlowconfidenceshort'] = 'Inconclusive (low confidence)';
